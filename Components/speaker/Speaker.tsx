...
const Speaker = () => {
 ...
 Music Experience
        ...
        <button className="bg-[#00FF66] w-[155px] h-[50px] rounded-[5px] text-[16px] text-[#FAFAFA] font-[500] mt-10">
         ...
         <div className="bg-[url('/speaker.svg')] bg-cover  float-right  bg-no-repeat max-2:w-[300px] max-2:h-[170px] w-[400px] h-[230px] sm:w-[560px] sm:h-[330px] md:w-[620px] lg:w-[510px] md:h-[350px] lg:h-[300px] xl:w-[575px] xl:h-[330px] overflow-hidden"></div>
